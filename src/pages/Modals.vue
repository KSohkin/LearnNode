...
<template>
    ...
    <ImgModal :active="modalActive" @close="modalActive = false" url="https://picsum.photos/seed/kaspar/200/300">
    </ImgModal>
    <ImgModal :active="modalActive2" @close="modalActive2 = false" url="https://picsum.photos/seed/martin/200/300">
    </ImgModal>
